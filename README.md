...
```javascript
import flatten3d from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten3d@v0.1.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { assign } from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-flatten3d@v0.1.0-deno/mod.js';
```
